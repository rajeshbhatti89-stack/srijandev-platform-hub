      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="relative p-1 bg-gray-900 border border-white/10 rounded-full flex items-center">
            ...
            <a
              href="https://plus.srijandev.in/login"
          ...
          <a href="https://plus.srijandev.in/login" className="hidden sm:flex items-center justify-center w-10 h-10 rounded-full border border-white/10 bg-gray-900 text-gray-400 hover:text-white hover:border-white/20 transition-all shadow-lg hover:shadow-emerald-500/10 hover:-translate-y-0.5">
            <User size={18} />
          </a>
        </div>
